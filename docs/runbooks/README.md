...
| --- | --- |
| [local-development.md](local-development.md) | Setting up a machine, running `make check` and the local stack |
| [deploy-free-tier.md](deploy-free-tier.md) | Deploying the public demo on Neon, Render and Vercel |
